...
The easiest way to run a ready-to-use Mark-a-Spot is by installing it via composer.

```
$ fin exec composer create-project markaspot/mark-a-spot:8.0.0rc1 project-dir
```
...
If you have drush installed replace the connection string with credentials of your database and run the following drush command. You can also point your browser to a apache or nginx powered virtual host that refers to `project_dir/web.
